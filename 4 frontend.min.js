...
!function() {
        ...
        if ("off-canvas" === e) {
            ...
            if (0 < l.length)
                for (let e = 0; e < l.length; e++) {
                    ...
                    for (link = 0,
                    len = r.length; link < len; link++)
                        null !== r[link].getAttribute("href") && (r[link].getAttribute("href").startsWith("#") || -1 !== r[link].getAttribute("href").search("#")) && (!r[link].parentElement.classList.contains("menu-item-has-children") || r[link].parentElement.classList.contains("menu-item-has-children") && document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-icon")) && (r[link].addEventListener("click", p, !0),
    ...
    document.addEventListener("astPartialContentRendered", function() {
        l = document.querySelectorAll(".main-header-menu-toggle"),
        u.classList.remove("ast-main-header-nav-open"),
        document.addEventListener("astMobileHeaderTypeChange", e, !1),
        n(),
        h()
    });
    var s = "Android" === navigator.userAgent.match(/Android/i) ? window.visualViewport.width : window.innerWidth;
    window.addEventListener("resize", function() {
        ...
        ("Android" === navigator.userAgent.match(/Android/i) ? window.visualViewport.width : window.innerWidth) !== s && (t && null === n && t.click(),
        document.body.classList.remove("ast-main-header-nav-open", "ast-popup-nav-open"),
        e && null == n && e.click()),
        r(),
        AstraToggleSetup())
            ...
            if (t && e) {
                ...
                if (void 0 !== a || void 0 !== (a = e.getElementsByTagName("a")[0])) {
                    ...
                    if (void 0 === n)
                        ...
                        "off-canvas" === d && (document.getElementById("menu-toggle-close").onclick = function() {
                        ...
                        ;
                        for (var s = n.getElementsByTagName("a"), o = n.getElementsByTagName("ul"), l = 0, r = o.length; l < r; l++)
                            o[l].parentNode.setAttribute("aria-haspopup", "true");
                        for (l = 0,
                        r = s.length; l < r; l++)
                            s[l].addEventListener("focus", b, !0),
                            s[l].addEventListener("blur", b, !0),
                            s[l].addEventListener("click", y, !0)
                    }
                }
            }
        }
    });
    for (var t, a, o, r = function() {
        ...
        astra.break_point < t || 0 === t) {
            if (0 < l.length)
                for (var a = 0; a < l.length; a++)
                    null !== l[a] && l[a].classList.remove("toggled");
    ...
    AstraToggleSubMenu = function(e) {
        ...
        for (var o = t.parentNode.querySelectorAll(".menu-item-has-children"), n = 0; n < o.length; n++)
            if (o[n] != t) {
                ...
                for (var l = o[n].querySelectorAll(".sub-menu"), r = 0; r < l.length; r++)
                        ...
                        for (var o, l = 0; l < t.length; l++)
                            if (0 < (o = document.querySelector("header.site-header").classList.contains("ast-builder-menu-toggle-link") ? t[l].querySelectorAll("ul.main-header-menu .menu-item-has-children > .menu-link, ul.main-header-menu .ast-menu-toggle") : t[l].querySelectorAll("ul.main-header-menu .ast-menu-toggle")).length)
                                for (var r = 0; r < o.length; r++)
                                    o[r].addEventListener("click", AstraToggleSubMenu, !1)
        }
    }
    ,
    astraNavMenuToggle = function(e) {
        if ("undefined" != typeof astraAddon)
            ...
            var e = document.querySelectorAll("#masthead > #ast-mobile-header .main-header-bar-navigation")
              , t = (l = document.querySelectorAll("#masthead > #ast-mobile-header .main-header-menu-toggle"),
            "0");
            ...
            l = document.querySelectorAll("#ast-fixed-header .main-header-menu-toggle"),
            t = "0"),
            void 0 === e[t])
                return !1;
        ...
        if (0 < e.length)
            for (var t = 0; t < e.length; t++) {
                ...
                for (var s = e[t].getElementsByClassName("children"), o = 0; o < s.length; o++)
                    s[o].style.display = "";
                for (var l = e[t].getElementsByClassName("ast-search-menu-icon"), r = 0; r < l.length; r++)
    ...
    /trident/i.test(o[1]) ? t = /\brv[ :]+(\d+)/g.exec(a) || [] : "Chrome" === o[1] && null != (t = a.match(/\bOPR|Edge\/(\d+)/)) || (o = o[2] ? [o[1], o[2]] : [navigator.appName, navigator.appVersion, "-?"],
    null != (t = a.match(/version\/(\d+)/i)) && o.splice(1, 1, t[1]),
    "Safari" === o[0] && o[1] < 11 && document.body.classList.add("ast-safari-browser-less-than-11")),
    document.getElementsByClassName("astra-search-icon")), f = 0; f < v.length; f++)
