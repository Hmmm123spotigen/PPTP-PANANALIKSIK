...
var WPFormsElementorFrontend = window.WPFormsElementorFrontend || function(o, r) {
    var t = {
        ...
        initFields: function(e) {
            ...
            "undefined" != typeof wpformsRecaptchaLoad && ("recaptcha" === wpformsElementorVars.captcha_provider && "v3" === wpformsElementorVars.recaptcha_type ? "undefined" != typeof grecaptcha && grecaptcha.ready(wpformsRecaptchaLoad) : wpformsRecaptchaLoad()),
            r(o).trigger("wpforms_elementor_form_fields_initialized", [e])
        }
    };
    return t
}(document, (window,
