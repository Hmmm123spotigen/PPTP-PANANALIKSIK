(()=>{
            ...
            window.selectSearchField = function(t) {
                ...
                (function() {
                    r.forEach(function(o) {
                        if (!o.hasAttribute("noDropdown") && !o.classList.contains("no-tutor-dropdown")) {
        ...
        3419: ()=>{
            window.jQuery(document).ready(function(d) {
                ...
                function f(t) {
                    ...
                    !Array.isArray(i) ? i = [] : 0;
                    var e = t.attr("data-quiz-feedback-mode");
                    d(".tutor-quiz-answer-single-info").remove();
                    d(".tutor-quiz-answer-single").removeClass("tutor-quiz-answer-single-correct tutor-quiz-answer-single-incorrect");
                    var a = true;
                    var r = t.find("input");
                    var n = t.find('input[type="radio"]:checked, input[type="checkbox"]:checked');
                    if (e === "reveal") {
                        n.each(function() {
                            var t = d(this);
                        ...
                        r.each(function() {
                            ...
                            if (e === "radio" || e === "checkbox") {
                                ...
                                var n = t.is(":checked");
                                if (r) {
                                    t.closest(".tutor-quiz-answer-single").addClass("tutor-quiz-answer-single-correct").append('<span class="tutor-quiz-answer-single-info tutor-color-success tutor-mt-8">\n                                        <i class="tutor-icon-mark tutor-color-success" area-hidden="true"></i>\n                                        '.concat(u("Correct Answer", "tutor"), "\n                                    </span>")).find(".tutor-quiz-answer-single-info:eq(1)").remove()
                                } else {
                                    if (t.prop("checked")) {
                ...
                d(".tutor-quiz-next-btn-all").prop("disabled", false);
                d(".quiz-attempt-single-question input").filter('[type="radio"], [type="checkbox"]').change(function() {
                    d(".tutor-quiz-next-btn-all").prop("disabled", false)
                });
                d(document).on("click", ".tutor-quiz-answer-next-btn, .tutor-quiz-answer-previous-btn", function(t) {
                    t.preventDefault();
                    var e = d(".tutor-quiz-question-counter>span:first-child");
                    var r = parseInt(d(this).closest("[data-question_index]").data("question_index"));
                    if (d(this).hasClass("tutor-quiz-answer-previous-btn")) {
                    ...
                    if (c) {
                        ...
                        if (s && s.length) {
                            ...
                            if (d(".tutor-quiz-questions-pagination").length) {
                                d(".tutor-quiz-question-paginate-item").removeClass("active");
                                d('.tutor-quiz-questions-pagination a[href="' + c + '"]').addClass("active")
                            }
                            e.text(r + 1)
                        }
                    }
                });
                d(document).on("click", ".tutor-quiz-question-paginate-item", function(t) {
                    t.preventDefault();
                    var e = d(this);
                    var r = d(e.attr("href"));
                    d(".quiz-attempt-single-question").hide();
                ...
                d(document).on("submit", "#tutor-answering-quiz", function(t) {
                ...
                d(".tutor-quiz-submit-btn").click(function(t) {
                    t.preventDefault();
                    d(this).attr("disabled", "disabled").addClass("is-loading");
                    d("#tutor-answering-quiz").submit()
                });
                var o = d("#tutor-quiz-time-update");
                d(document).on("click", "a", function(t) {
                    ...
                    if (o.length > 0 && o.text() != "EXPIRED") {
                        ...
                        var e = {
                            ...
                            buttons: {
                                keep: {
                                    ...
                                    callback: function t() {
                                        var e = d("form#tutor-answering-quiz").serialize() + "&action=" + "tutor_quiz_abandon";
                                        d.ajax({
                        ...
                        n = new window.tutor_popup(d,"").popup(e)
                    }
                });
                d("body").on("submit", "form#tutor-start-quiz", function() {
    ...
    (()=>{
        ...
        window.jQuery(document).ready(function(i) {
            var a = wp.i18n.__;
            i(document).on("submit", "#tutor-login-form", function(t) {
                t.preventDefault();
                var e = i(this);
                var r = e.find("button");
                var n = e.find(".tutor-login-error");
                var o = i(this).serializeObject();
                o.action = "tutor_user_login";
                i.ajax({
                    url: _tutorobject.ajaxurl,
                    type: "POST",
                    data: o,
                    ...
                    success: function t(e) {
                        ...
                        var r = (e.data || {}).message || a("Invalid username or password!", "tutor");
                        n.html('\n                    <div class="tutor-alert tutor-warning tutor-mt-28">\n                        <div class="tutor-alert-text">\n                            <span class="tutor-alert-icon tutor-icon-34 tutor-icon-circle-info tutor-mr-12"></span>\n                            <span>\n                                '.concat(r, "\n                            </span>\n                        </div>\n                    </div>\n                "))
                    },
                    error: function t() {
                        tutor_toast(a("Error!", "tutor"), (0,
                        u.get_response_message)(), "error")
                    },
                    complete: function t() {
                        r.removeClass("is-loading")
                    }
                            ...
                            while (1) {
                                ...
                                case 22:
                                    ...
                                    if (d.success) {
                                        ...
                                        f = d.data || {},
                                        p = f.message,
                                        h = p === void 0 ? w("Something went wrong, please try again ", "tutor") : p;
                        ...
                        return q().wrap(function t(e) {
                            while (1) {
                                ...
                                case 11:
                                    ...
                                    if (a) {
                                        tutor_toast(w("Delete", "tutor"), w("Course has been deleted ", "tutor"), "success");
                                        location.reload()
                                    } else {
                                        tutor_toast(w("Failed", "tutor"), w("Course delete failed ", "tutor"), "error")
                                    }
                                case 14:
                                case "end":
                                    return e.stop()
        ...
        document.addEventListener("DOMContentLoaded", function(t) {
            ...
            var S = document.getElementById("tutor-assignment-file-upload");
            if (S) {
        ...
        var m = ["keyword", "course_order", "tutor-course-filter-level", "tutor-course-filter-tag", "tutor-course-filter-category", "tutor-course-filter-price", "course_filter", "supported_filters", "current_page", "action"];
        var g = function t(i) {
        ...
        window.jQuery(document).ready(function(i) {
            ...
            var u = i("[tutor-course-filter] form");
            if (!u.length) {
                return
            }
            var c = i("[tutor-course-list-container]");
            var s = i(".tutor-courses-wrap").data("tutor_courses_meta") || {};
            var l = {};
            ...
            var e = function t() {
                ...
                c.html('<div class="tutor-spinner-wrap"><span class="tutor-spinner" area-hidden="true"></span></div>');
                u.find("[action-tutor-clear-filter]").closest(".tutor-widget-course-filter").removeClass("tutor-d-none");
                i.ajax({
                    url: window._tutorobject.ajaxurl,
                    type: "POST",
                    data: o,
                    success: function t(e) {
                        if (!e.success) {
                            c.html(a("Could not load courses", "tutor"));
                            return
                        }
            ...
            function b(u, c) {
                function s(t, e, r, n) {
                    ...
                    if ("throw" !== o.type) {
                        var i = o.arg
                          , a = i.value;
                        return a && "object" == T(a) && l.call(a, "__await") ? c.resolve(a.__await).then(function(t) {
                            s("next", t, r, n)
                        }, function(t) {
                            s("throw", t, r, n)
                        }) : c.resolve(a).then(function(t) {
                                ...
                                case 14:
                                    ...
                                    if (a.success) {
                                        ...
                                        if (a.data.error_message) {
                                            tutor_toast(D("Failed", "tutor"), a.data.error_message, "error")
                                        } else {
                                            tutor_toast(D("Failed", "tutor"), n, "error")
                                        }
                                    }
                                    e.next = 19;
                                    break;
            ...
            !function(e) {
                function r(t, e) {
                    if (!(t.originalEvent.touches.length > 1)) {
                        ...
                        n.initMouseEvent(e, !0, !0, window, 1, r.screenX, r.screenY, r.clientX, r.clientY, !1, !1, !1, !1, 0, null),
                        t.target.dispatchEvent(n)
                    }
                }
                if (e.support.touch = "ontouchend"in document,
                e.support.touch) {
                    var n, t = e.ui.mouse.prototype, o = t._mouseInit, i = t._mouseDestroy;
                    t._touchStart = function(t) {
                        var e = this;
                        !n && e._mouseCapture(t.originalEvent.changedTouches[0]) && (n = !0,
                        e._touchMoved = !1,
                        r(t, "mouseover"),
                        r(t, "mousemove"),
                        r(t, "mousedown"))
