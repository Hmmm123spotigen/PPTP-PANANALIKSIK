    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                ...
                if ("hover" === a || i === this)
                    ...
                    if (n.hasClass("item-opened"))
                        return void (!l && s?.url && window.open(s.url, r))
                }
            }
            ))
        },
        Nav_Menu: function(t) {
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(i) {
                    if (i.preventDefault(),
                    e(document).width() < Number(n))
                        return;
                    let s = e(this).parent()
                      , a = e(this).parents(".elementskit-dropdown-has")
                      , o = s.find(">.elementskit-dropdown, >.elementskit-megamenu-panel");
                    t.find(".elementskit-dropdown-has").not(a).find(">.elementskit-dropdown, >.elementskit-megamenu-panel").removeClass("ekit-dropdown-open-onclick"),
                    o.toggleClass("ekit-dropdown-open-onclick")
                }
                )),
                e(window).on("resize", (function() {
        ...
        Client_Logo: function(e) {
            ...
            t.dots && (t.pagination = {
                ...
                renderCustom: (e,t,n)=>{
                    var i = "";
                    for (let e = 1; e <= n; e++)
                        i += '<li role="presentation" class="' + (t === e ? " swiper-pagination-bullet-active slick-active" : "swiper-pagination-bullet") + '"><button type="button" role="tab"  tabindex="0" aria-selected="true" class="">' + e + "</button></li>";
                    return i
                }
            });
        ...
        PostTab: function(t) {
            ...
            t.on(n, ".tab__list__item", (function() {
                var t = e(this)
                  , n = s.eq(t.index());
                i.add(s).removeClass("active"),
                t.add(n).addClass("active")
            }
            ))
        },
        ...
        Back_To_Top: function(t) {
            const n = t.find(".ekit-btt__button")
              , {offset_top: i, show_after: s, show_scroll: a, style: o, fg: l, bg: r} = t.find(".ekit-btt").data("settings");
    ...
    e.fn.myChart = function(t) {
        ...
        return this.easyPieChart({
            barColor: !0 === n.gradientChart ? function(e) {
                ...
                return s.addColorStop(0, n.gradientColor1),
                s.addColorStop(1, n.gradientColor2),
                s
            }
            : n.barColor,
